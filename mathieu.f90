...
module mathieu
    ...
    subroutine matfcn(lnum, ioprad, izxi, icq, isq, qc, r, iopang, narg, arg, &
        ...
        integer     ndec, nex, kindd, kindq, minacc, max, maxd, maxj, maxk, maxn, maxp, &
                    maxlp, maxbp, maxkbp, ndm, ismax, maxterm, ngau
        real(knd)   q, cm, z, x1
        ...
        call mathieuf(lnum, cm, q, icq, isq, ioprad, iopang, minacc, izxi, x1, z,  &
                   narg, arg, maxd, maxj, maxlp, maxn, maxp, maxkbp, maxk, ndec, &
        ...
        subroutine mathieuf(lnum, cm, q, icq, isq, ioprad, iopang, minacc, izxi, x1, z, &
                            narg, arg, maxd, maxj, maxlp, maxn, maxp, maxkbp, maxk, ndec, &
                            nex, ngau, kindd, kindq, &
                            mc1c, mc1e, mc1dc, mc1de, mc23c, mc23e, mc23dc, mc23de, naccrc, &
                            ms1c, ms1e, ms1dc, ms1de, ms23c, ms23e, ms23dc, ms23de, naccrs, &
        ...
        real(knd) api, a01, asubl, b12, bsubl, cm, cepio2, cedpio2, ce0, dec, &
                  ...
                  gamma, m1botc, m1bots, mc1c_, mc1dc_, mc2c_, mc2dc_, mc3c_, mc3dc_, &
                  ms1c_, ms1dc_, ms2c_, ms2dc_, ms3c_, ms3dc_, m3bot, pi, q, rl, sed0, &
                  sepio2, sedpio2, sgna, sgnb, wroncc, wroncs, wront, xi, xb, x1, z
        ...
        integer   ibese(maxlp), ibese1(maxlp), ibese2(maxlp), &
